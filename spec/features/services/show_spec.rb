...
describe 'As a logged in user' do
  describe 'When I click on a company from the service type index page' do
    it 'I am taken to that companys show page to see their info' do
      ...
      stub_request(:get, 'https://relocate-back-end-rails.herokuapp.com/api/v1/yelp?id=9s8dfs7fsdmsdf&location=80211&service=utilities&type=Electricity')
        .to_return(status: 200, body: json_response, headers: {})

      visit '/80211/utilities/Electricity/9s8dfs7fsdmsdf'
